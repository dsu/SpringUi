...
@Scope("prototype")
@EqualsAndHashCode
public class TextAreaT extends AbstractInputField {

	protected MapTemplateEngine engine;

	@Autowired
	public TextAreaT(UiCtx ctx, @Qualifier("thymeleaf") MapTemplateEngine engine) {
		super(ctx);
		this.engine = engine;
	}

	protected String getTemplatePath() {
		return "components/fields/textarea.xhtml";
	}
