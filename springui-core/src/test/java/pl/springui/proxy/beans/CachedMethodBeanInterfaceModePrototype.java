...
public class CachedMethodBeanInterfaceModePrototype extends BaseBean implements HTMLRenderer, CachedFakeInterface {

	public CachedMethodBeanInterfaceModePrototype() {
		super();
	}
