...
import pl.springui.components.Js;
...
import pl.springui.components.layouts.Layout;
...
import pl.springui.example.components.list.UserListT;
...
public class Tpage extends UiComponent {
	...
	public void restoreView() {
		...
		ajaxBtn.setOnClick(Js.reloadComponent(nameField.getClientId()));
		...
		VerticalMenu menu = getCtx().get(VerticalMenu.class);
	...
	/**
	 * Caching when there is no request paramters
	 */
	@Override
	@Cacheable(cacheNames = "pages", keyGenerator = "uiComponentKey", unless = "@tpage.hasRequestParameters()")
